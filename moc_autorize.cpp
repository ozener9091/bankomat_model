...
void AutorizeWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AutorizeWindow *>(_o);
        (void)_t;
        switch (_id) {
...
void *AutorizeWindow::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_AutorizeWindow.stringdata0))
        return static_cast<void*>(this);
    return QMainWindow::qt_metacast(_clname);
}

int AutorizeWindow::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
